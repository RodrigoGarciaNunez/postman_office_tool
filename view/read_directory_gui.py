...
class read_directory_gui(Frame):
     def __init__(self, parent, context:root):
        ...
        Label(self, text="Directorio:", bg="skyblue").grid(row=0, column=0, padx=0, pady=0, sticky="w")
        
        entry_file_dir = Entry(self, width=20)
        entry_file_dir.grid(row=0, column=1, padx=0, pady=0, sticky="w")
        ...
        ### ocupa tener su propio frame o zona para que se no afecte sus demensiones,mañana queda
        Label(self, text= "Directorio").grid(row=0, column= 7, padx=5, pady=5, sticky="nsew")
        directory_text = scrolledtext.ScrolledText(self, width=50, height=40)
...
if __name__ == "__main__":
    container = Frame(height="800", width="600")
